  ...
  return (
    <>
      ...
      <div className="grid grid-row-3 p-7 header">
        <div className="flex items-center header__top">
          ...
          {sideMenu && (
            <div
              ...
              className="font-bold text-sm pl-5 pt-5 z-10 pb-4 absolute bg-white mt-52 shadow-2xl border border-gray-300 left-0 w-48"
            >
              <h1
          ...
          {searchIcon ? (
            <>
              ...
              <h1 className="text-xs ml-36">U.S.</h1>
            </>
          ) : (
            <>
          ...
          {auth?.currentUser ? (
            <button onClick={logout} className="ml-96 text-xs">LOGOUT</button>
          ) : (
            <Link to="/login">
              <button className="text-xs ml-96 bg-slate-500 p-1 w-16 text-white font-bold rounded-sm">
                LOG IN
              </button>
            </Link>
          )}
        ...
        <div>
          <hr className="mt-2" />
          <div className="flex text-sm mt-3 header__menu">
            <h1
